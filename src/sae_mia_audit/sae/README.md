...
| `io.py` | `load_sae_checkpoint`, `load_sae_cfg`, `load_sae_checkpoint_any` (checkpoint readers, supporting both this package's format and the SAIF format). | All paper scripts that load an SAE |
