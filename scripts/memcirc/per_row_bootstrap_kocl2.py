...
def _bidirectional_auroc(labels: np.ndarray, scores: np.ndarray) -> Tuple[float, int]:
    ...
    Mirrors `bidirectional_auroc` in scripts/memcirc/sae_dark_subspace.py.
    """
...
def main():
    ...
    ap.add_argument("--output",
                    default="paper5/results/k_oc2_bootstrap_2026-05-02.json",
    ...
    output = {
        ...
        "script": "scripts/memcirc/per_row_bootstrap_kocl2.py",
    }
