...
# Reproduce. sbatch scripts/memcirc/shell/sbatch_subspace_ablation.sh
#
# Spec. paper5/experiment_designs/causal_intervention.md.
# Script. scripts/memcirc/subspace_ablation_eval.py (error-PC target).
#
...
#
# Outputs. runs/memcirc/causal_ablation/{model}_errPC_K{k}/results.json,
#          runs/memcirc/causal_ablation/aggregate.json,
#          runs/memcirc/causal_ablation/run_config.json.

set -euo pipefail
cd "$(dirname "$0")/../../.."

PYTHON="env/bin/python3"
SCRIPT="scripts/memcirc/subspace_ablation_eval.py"
...
OUT_DIR="runs/memcirc/causal_ablation"
