...
# Reproduce: sbatch scripts/memcirc/shell/sbatch_multiseed_mixed_sae_p69.sh
#
...
for SEED in "${SEEDS[@]}"; do
  ...
  OUTPUT_DIR="runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed${SEED}"
...
for SEED in "${SEEDS[@]}"; do
  echo "  Seed $SEED: runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed${SEED}/results.json"
done
