...
# paper.
# Reproduce: sbatch scripts/memcirc/shell/multiseed/sbatch_p1b.sh
#
...
P1B_BCD="runs/memcirc/behavioral_channels/p1b_epoch5"
CORPUS="data/memcirc_ctrl_ft/mixed.jsonl"
...
DSS_OUTPUT_DIR="runs/memcirc/sae_dark_subspace/p1b_mixed_sae_seed${SEED}"
