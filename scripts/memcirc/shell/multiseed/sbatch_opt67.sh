...
#
# Reproduce: sbatch scripts/memcirc/shell/multiseed/sbatch_opt67.sh
#
#
...
OPT_BCD="runs/memcirc/behavioral_channels/opt67_epoch5"
CORPUS="data/memcirc_ctrl_ft/mixed.jsonl"
...
DSS_OUTPUT_DIR="runs/memcirc/sae_dark_subspace/opt67_mixed_sae_seed${SEED}"
