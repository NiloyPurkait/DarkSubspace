...
#
# Reproduce: sbatch scripts/memcirc/shell/multiseed/sbatch_gemma2_2b.sh
#
#
...
# runs/memcirc/behavioral_channels/gemma2_2b_epoch5/.
...
GEMMA_BCD="runs/memcirc/behavioral_channels/gemma2_2b_epoch5"
CORPUS="data/memcirc_ctrl_ft/mixed.jsonl"
...
DSS_OUTPUT_DIR="runs/memcirc/sae_dark_subspace/gemma2_2b_mixed_sae_seed${SEED}"
