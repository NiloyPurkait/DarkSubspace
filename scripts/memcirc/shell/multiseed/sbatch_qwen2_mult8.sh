...
# paper.
# Reproduce: sbatch scripts/memcirc/shell/multiseed/sbatch_qwen2_mult8.sh
#
...
QWEN_BCD="runs/memcirc/behavioral_channels/qwen2_epoch5"
CORPUS="data/memcirc_ctrl_ft/mixed.jsonl"
...
DSS_OUTPUT_DIR="runs/memcirc/sae_dark_subspace/qwen2_mixed_mult8_seed${SEED}"
