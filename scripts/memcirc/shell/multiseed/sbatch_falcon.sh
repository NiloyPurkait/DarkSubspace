...
# of the paper.
#
# Reproduce: sbatch scripts/memcirc/shell/multiseed/sbatch_falcon.sh
#
#
...
FALCON_BCD="runs/memcirc/behavioral_channels/falcon7b_epoch5_v2"
...
DSS_OUTPUT_DIR="runs/memcirc/sae_dark_subspace/falcon_mixed_sae_seed${SEED}"
