...
#
# SLURM wrapper for scripts/memcirc/behavioral_channels.py on the
...
# Reproduce: sbatch scripts/memcirc/shell/sbatch_pre_ft_baseline.sh
#
# Expected outcome.
...
env/bin/python3 scripts/memcirc/behavioral_channels.py \
  ...
  --output-dir runs/memcirc/behavioral_channels/p69_BASE_pre_ft

echo "=== pre-FT baseline done: $(date) ==="
echo "Inspect:  runs/memcirc/behavioral_channels/p69_BASE_pre_ft/"
