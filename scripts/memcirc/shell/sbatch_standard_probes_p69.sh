...
# Reproduce: sbatch scripts/memcirc/shell/sbatch_standard_probes_p69.sh
#
...
OUT_DIR="runs/memcirc/standard_mia_probes/p69_dark_subspace_replication"
mkdir -p "$OUT_DIR"
...
${PY} scripts/memcirc/standard_mia_probe_decomposition.py \
