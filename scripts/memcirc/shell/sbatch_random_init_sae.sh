...
# Reproduce: sbatch scripts/memcirc/shell/sbatch_random_init_sae.sh
#
...
P69_BCD="runs/memcirc/behavioral_channels/p69_epoch5"
...
${PY} scripts/memcirc/make_random_sae.py \
...
${PY} scripts/memcirc/sae_dark_subspace.py \
  ...
  --layer $LAYER \
  --output-dir runs/memcirc/sae_dark_subspace/p69_random_init_v2 \
  --model-id p69_random_init_v2

echo "=== DONE: $(date) ==="
echo "SAE: $RAND_SAE"
echo "Eval: runs/memcirc/sae_dark_subspace/p69_random_init_v2/results.json"
