...
# Reproduce. sbatch scripts/memcirc/shell/sbatch_paraphrase_qwen2_p12b.sh
#
...
#   runs/memcirc/paraphrase_sensitivity/qwen2/
#   runs/memcirc/paraphrase_sensitivity/p12b/
#
# MODEL/SAE/LAYER values taken from scripts/memcirc/configs/oc_roster.json.
...
OUT_ROOT="runs/memcirc/paraphrase_sensitivity"
...
QWEN2_BCD="runs/memcirc/behavioral_channels/qwen2_epoch5"
