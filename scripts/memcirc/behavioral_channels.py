...
membership and recall to ``runs/memcirc/behavioral_channels/<condition>/orthogonality.json``.

Used in Methods §3.2 (BCD), Results §4.1 (geometry), and Appendix BCD details.
Reproduce:
    env/bin/python3 scripts/memcirc/behavioral_channels.py \\
        ...
        --extractability-json runs/memcirc/extractability_control_v2/p69_epoch5_layer16/extractability_control.json \\
        --sae-path runs/sae/memcirc_p69_epoch5_layer16_8x_l1_1e4_member/sae_final.pt \\
        --feature-classification runs/memcirc/discovery/p69_epoch5_layer16_8x_l1_1e4_member_story/feature_classification.json \\
        --sae-layer 16 --layers 0 4 8 12 16 20 24 28 31 \\
        --output-dir runs/memcirc/behavioral_channels/p69_epoch5
