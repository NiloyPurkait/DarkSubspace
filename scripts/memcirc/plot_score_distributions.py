...
Reproduce: ``env/bin/python3 scripts/memcirc/plot_score_distributions.py``
(writes PDF and PNG, 300 DPI, to ``paper5/figures/``).

Outputs:
  paper5/figures/score_distributions.pdf         2x3 full version (appendix)
  paper5/figures/score_distributions_simple.pdf  1x3 simple version (main body)
"""
...
MEMBER_ONLY = ROOT / "runs/memcirc/sae_dark_subspace/p69_epoch5_v2/results.json"
...
# runs/memcirc/sae_noise_floor/p69_aggregate.json.
MIXED_SAE   = ROOT / "runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed42_postfix/results.json"
# Simple figure pools all 6 mixed-data SAE seeds for the cohort-level KDE
# and reports the N=6 mean AUROC.
MIXED_SAE_SEEDS = [
    ROOT / f"runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed{s}/results.json"
    for s in ["42_postfix", "43", "44", "45", "46", "47"]
]
OUT_DIR     = ROOT / "paper5/figures"
