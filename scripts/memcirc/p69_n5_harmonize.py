...
Background.
  The N=6 P69 mixed-data SAE cohort lives at
    runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed{42_postfix,43,44,45,46,47}/
...
Reproduce.
    env/bin/python3 scripts/memcirc/p69_n5_harmonize.py
    env/bin/python3 scripts/memcirc/p69_n5_harmonize.py --json
...
Outputs.
  ...
  Disk. JSON file at
    paper5/results/p69_n5_harmonized_2026-05-06.json
...
def main() -> None:
    ...
    base = args.repo_root / "runs/memcirc/sae_dark_subspace"
    n6_path = args.repo_root / "runs/memcirc/sae_noise_floor/p69_aggregate.json"
    ...
    payload = {
        ...
        "notes": [
            ...
            "Cohort mirrors the noise-floor aggregator at runs/memcirc/sae_noise_floor/p69_aggregate.json.",
    ...
    out_dir = args.repo_root / "paper5/results"
