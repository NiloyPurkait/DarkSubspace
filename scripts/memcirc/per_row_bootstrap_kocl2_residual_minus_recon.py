...
Reproduce:
    env/bin/python3 scripts/memcirc/per_row_bootstrap_kocl2_residual_minus_recon.py
...
COHORT_ROWS: List[Tuple[str, str, bool]] = [
    ("P1B mult4 layer14 seed42",
     "runs/memcirc/sae_dark_subspace/p1b_mixed_sae_layer14_seed42/results.json", True),
    ("P2.8B mult4 layer20 seed42",
     "runs/memcirc/sae_dark_subspace/p2_8b_mixed_sae_seed42/results.json", True),
    ("Qwen2 mult4 seed42",
     "runs/memcirc/sae_dark_subspace/qwen2_mixed_seed42/results.json", True),
    ("Qwen2 mult8 seed42",
     "runs/memcirc/sae_dark_subspace/qwen2_mixed_mult8_seed42/results.json", True),
    ("Neo mult8 seed42",
     "runs/memcirc/sae_dark_subspace/neo_mixed_mult8_seed42/results.json", True),
    ("P69 N=6 anchor seed42_postfix",
     "runs/memcirc/sae_dark_subspace/p69_mixed_sae_seed42_postfix/results.json", False),
    ("P12B fresh-init seed47",
     "runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed47/results.json", False),
]

QWEN2_MULT4_SECONDARY_SEEDS: List[Tuple[str, str]] = [
    ("Qwen2 mult4 seed43 (secondary)",
     "runs/memcirc/sae_dark_subspace/qwen2_mixed_seed43/results.json"),
    ("Qwen2 mult4 seed44 (secondary)",
     "runs/memcirc/sae_dark_subspace/qwen2_mixed_seed44/results.json"),
]
...
def main():
    ...
    ap.add_argument(
        "--output",
        default="paper5/results/k_oc2_bootstrap_residual_minus_reconstruction_2026-05-05.json",
    ...
    output = {
        ...
        "supersedes_in_appendix": "paper5/results/k_oc2_bootstrap_2026-05-02.json (residual minus original margin)",
        "harmonisation_note": (
        ...
        "script": "scripts/memcirc/per_row_bootstrap_kocl2_residual_minus_recon.py",
    }
