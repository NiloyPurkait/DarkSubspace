...
over ``runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed{47..51}/results.json``
...
Reproduce::
    ...
    env/bin/python3 scripts/memcirc/p12b_multiseed_query.py [--json] \\
...
RESULTS_TPL = "runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed{seed}/results.json"
CONFIG_TPL = "runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed{seed}/config.json"

# Single-seed anchor (seed 42) used for context with --include-anchor.
ANCHOR_SEED = 42
ANCHOR_RESULTS = "runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed42/results.json"
...
def main():
    ...
    print(f"Source: {ROOT}/runs/memcirc/sae_dark_subspace/p12b_mixed_sae_seed{{47..51}}/results.json")
    print()
    if missing:
