...
Reproduce: env/bin/python3 scripts/memcirc/fresh_probe_test.py --model-path <ft_model> --sae-path <sae> --bcd-dir <bcd_dir> --member-texts <member.jsonl> --nonmember-texts <nonmember.jsonl> --layer <L> --output-dir <out> --model-id <id>
