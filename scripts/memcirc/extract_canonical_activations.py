...
Reproduce:
    env/bin/python3 scripts/memcirc/extract_canonical_activations.py \\
        ...
        --out-prefix runs/memcirc/activations_canonical/p69_epoch5_layer16
...
def main():
    ...
    meta = {
        ...
        "script": "scripts/memcirc/extract_canonical_activations.py",
    }
