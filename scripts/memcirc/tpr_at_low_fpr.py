...
the paper. Reproduce:
    env/bin/python3 scripts/memcirc/tpr_at_low_fpr.py --all
...
Single-model usage:
    env/bin/python3 scripts/memcirc/tpr_at_low_fpr.py --model p69
"""
