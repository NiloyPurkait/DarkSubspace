...
Reproduce: env/bin/python3 scripts/memcirc/feature_ablation_dark_subspace.py --model-path <ft_model> --bcd-dir <bcd_dir> --sae-path <sae> --member-texts <member.jsonl> --nonmember-texts <nonmember.jsonl> --layer <L> --output-dir <out> --model-id <id>
