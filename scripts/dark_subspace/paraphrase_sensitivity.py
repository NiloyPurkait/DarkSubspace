...
Reproduce:
  .venv/bin/python scripts/dark_subspace/paraphrase_sensitivity.py \\
      ...
      --output-dir runs/dark_subspace/paraphrase_sensitivity \\
      --mode word_shuffle
...
Output. runs/dark_subspace/paraphrase_sensitivity/p69/results.json,
        runs/dark_subspace/paraphrase_sensitivity/p69/per_text_scores.json,
        runs/dark_subspace/paraphrase_sensitivity/p69/paraphrase_cache.json
