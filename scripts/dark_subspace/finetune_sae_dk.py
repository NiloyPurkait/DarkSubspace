...
Reproduce: .venv/bin/python scripts/dark_subspace/finetune_sae_dk.py --sae-path <sae> --model-path <ft_model> --bcd-dir <bcd_dir> --layer <L> --dk-coeff 0.01 --steps 5000 --corpus <mixed.jsonl> --output-dir <out>
