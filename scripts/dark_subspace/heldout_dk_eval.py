...
Inputs (canonical caches).
  P69 layer 16 (Pythia-6.9B FT epoch 5).
    runs/dark_subspace/activations_canonical/p69_epoch5_layer16_member.npy   (1000, 4096)
    runs/dark_subspace/activations_canonical/p69_epoch5_layer16_nonmember.npy (1000, 4096)
  P12B layer 18 (Pythia-12B FT epoch 5).
    runs/dark_subspace/activations_canonical/p12b_epoch5_layer18_member.npy   (1000, 5120)
    runs/dark_subspace/activations_canonical/p12b_epoch5_layer18_nonmember.npy (1000, 5120)
...
Output JSON. results/dark_subspace/paper_claims/heldout_dk_2026-05-02.json.
...
ANCHORS: List[Dict] = [
    {
        ...
        "layer": 16,
        "used_seed": 43,
        "member_acts": "runs/dark_subspace/activations_canonical/p69_epoch5_layer16_member.npy",
        "nonmember_acts": "runs/dark_subspace/activations_canonical/p69_epoch5_layer16_nonmember.npy",
        ...
        "anchor_results_json": "runs/dark_subspace/sae_dark_subspace/p69_mixed_sae_seed43/results.json",
    ...
    },
    {
        ...
        "layer": 18,
        "used_seed": 49,
        "member_acts": "runs/dark_subspace/activations_canonical/p12b_epoch5_layer18_member.npy",
        "nonmember_acts": "runs/dark_subspace/activations_canonical/p12b_epoch5_layer18_nonmember.npy",
        ...
        "anchor_results_json": "runs/dark_subspace/sae_dark_subspace/p12b_mixed_sae_seed49/results.json",
...
def _sae_reconstruct(
    ...
    sys.path.insert(0, str(REPO_ROOT / "scripts" / "dark_subspace"))
...
def main():
    ...
    ap.add_argument("--output",
                    default="results/dark_subspace/paper_claims/heldout_dk_2026-05-02.json")
    ...
    output = {
        ...
        "timestamp_utc": time.strftime("%Y-%m-%d %H:%M:%S UTC", time.gmtime()),
        "script": "scripts/dark_subspace/heldout_dk_eval.py",
    }
