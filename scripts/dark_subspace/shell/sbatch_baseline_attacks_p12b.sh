...
# scripts/dark_subspace/baseline_attacks_suite.py in single-model mode, writing to
# runs/dark_subspace/baseline_attacks/p12b/{results.json,per_text_scores.json}
# without touching the shared aggregate.json.
#
# Used in Appendix app:tpr_paraphrase and the per-method results paragraph
# of the paper.
# Reproduce: bash scripts/dark_subspace/shell/sbatch_baseline_attacks_p12b.sh
#
# Notes.
...
OUT_DIR="runs/dark_subspace/baseline_attacks"

# p12b roster entry (mirrors scripts/dark_subspace/configs/oc_roster.json)
MODEL_TAG="p12b"
MODEL_PATH="runs/controlled_ft/run_20260308_001316/ft_epoch5/model"
BCD_DIR="runs/dark_subspace/behavioral_channels/p12b_epoch5"
