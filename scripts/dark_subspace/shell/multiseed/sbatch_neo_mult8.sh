...
# paper.
# Reproduce: sbatch scripts/dark_subspace/shell/multiseed/sbatch_neo_mult8.sh
#
...
NEO_BCD="runs/dark_subspace/behavioral_channels/neo_epoch5"
CORPUS="data/memcirc_ctrl_ft/mixed.jsonl"
...
DSS_OUTPUT_DIR="runs/dark_subspace/sae_dark_subspace/neo_mixed_mult8_seed${SEED}"
